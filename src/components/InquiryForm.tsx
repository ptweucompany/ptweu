    ...
    return (
      <div className="text-center py-16 px-6">
        ...
        <p className="text-gray-500 text-sm mb-8">
          {lang === 'en'
            ? 'Our team will contact you within 1 business day. We have received your inquiry via our official B2B portal.'
            : 'Tim kami akan menghubungi Anda dalam 1 hari kerja. Kami telah menerima inquiry Anda melalui portal B2B resmi.'}
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button onClick={() => { setDone(false); setStep(0); setData(INIT); }}
            className="px-8 py-4 bg-[#0A1628] text-white font-bold rounded-xl hover:bg-[#1a2d48] transition-colors">
            {lang === 'en' ? 'Back Home' : 'Kembali ke Beranda'}
          </button>
          <button onClick={() => { setDone(false); setStep(0); setData(INIT); }}
