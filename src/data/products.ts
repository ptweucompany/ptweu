...
export const agregat: ProductData = {
  ...
  slug_en: 'aggregate',
  name_id: 'Batu Giling',
  name_en: 'Crushed Stone (Batu Giling)',
  image: '/products/agregat-beton.webp',
  hero_subtitle_id: 'Batu Kapur Pecah Ukuran 1x2 & 2x3 — Langsung dari Tambang Ratatotok',
  hero_subtitle_en: 'Crushed Limestone 1x2 & 2x3 — Directly from Ratatotok Quarry',
  description_id:
    'Batu giling kami adalah batu kapur (limestone) yang dipecah menggunakan crusher plant 250 TPH di tambang Ratatotok, Minahasa Tenggara. Produk ini tersedia dalam ukuran 1x2 cm (10–20 mm) dan 2x3 cm (20–30 mm), cocok untuk kebutuhan konstruksi umum, pengurugan, dan campuran. Batu giling ini bukan agregat beton bersertifikasi SNI — untuk kebutuhan beton struktural bersertifikat, harap konsultasikan dengan tim kami.',
  description_en:
    'Our crushed stone (batu giling) is limestone processed through our 250 TPH crusher plant at the Ratatotok quarry, Southeast Minahasa. Available in 1x2 cm (10–20 mm) and 2x3 cm (20–30 mm) sizes, suitable for general construction, backfilling, and mixing. This product is not SNI-certified structural concrete aggregate — please consult our team for certified structural applications.',
  specs: [
    { label: 'Jenis Batuan', value: 'Batu Kapur (Limestone)' },
    { label: 'Ukuran 1x2', value: '10 – 20 mm' },
    { label: 'Ukuran 2x3', value: '20 – 30 mm' },
    { label: 'Kadar Lumpur (Sludge)', value: '< 1%' },
    { label: 'Kadar CaO', value: '> 55%' },
    { label: 'Berat Jenis (Specific Gravity)', value: '± 2.65 g/cm³' },
  ],
  size_variants: ['1x2 cm (10–20 mm)', '2x3 cm (20–30 mm)'],
  key_features_id: [
    'Dua pilihan ukuran: 1x2 dan 2x3 sesuai kebutuhan proyek',
    'Diproses dari batu kapur Ratatotok berkadar CaO tinggi',
    'Kadar lumpur rendah (<1%) dari sistem washing plant',
    'Pasokan volume besar langsung dari tambang',
    'Pengiriman via darat (dump truck) maupun laut (tongkang)',
  ],
  key_features_en: [
    'Two size options: 1x2 and 2x3 to suit project needs',
    'Processed from high-CaO Ratatotok limestone',
    'Low sludge content (<1%) from washing plant system',
    'Large volume supply direct from quarry',
    'Delivery via land (dump truck) or sea (barge)',
  ],
  applications: [
    { industry: 'Konstruksi Umum', use: 'Campuran beton umum, pengurugan, dan sirtu untuk lantai kerja dan pondasi ringan', icon: 'Building' },
    { industry: 'Pengerasan Jalan', use: 'Lapis pondasi jalan non-struktural, pengerasan area tambang, dan akses jalan sementara', icon: 'Construction' },
    { industry: 'Reklamasi & Urugan', use: 'Material urugan untuk proyek reklamasi pantai dan penimbunan area industri', icon: 'Layers' },
    { industry: 'Campuran Aspal', use: 'Campuran material untuk hotmix dan perkerasan ringan di proyek infrastruktur daerah', icon: 'Truck' },
  ],
  certs: ['Certificate of Analysis (COA) per pesanan', 'Analisis Gradasi Internal', 'Uji Kadar Lumpur'],
  faq_id: [
    { q: 'Ukuran apa saja yang tersedia untuk batu giling?', a: 'Kami menyediakan dua ukuran: 1x2 cm (10–20 mm) dan 2x3 cm (20–30 mm). Ukuran lain dapat didiskusikan sesuai konfigurasi crusher plant kami.' },
    { q: 'Apakah batu giling ini sama dengan agregat beton SNI?', a: 'Tidak. Batu giling adalah batu kapur yang dipecah dari tambang kami. Produk ini tidak dipasarkan sebagai agregat beton bersertifikat SNI. Untuk kebutuhan beton struktural bersertifikat, harap konsultasikan terlebih dahulu.' },
    { q: 'Berapa kapasitas produksi harian batu giling?', a: 'Kapasitas crusher plant kami mencapai 250 ton per jam, dengan produksi harian 2.000–3.000 ton tergantung konfigurasi fraksi.' },
    { q: 'Bagaimana sistem pengiriman untuk batu giling?', a: 'Pengiriman darat menggunakan dump truck dari tambang Ratatotok. Untuk volume besar, tersedia pengiriman via tongkang melalui Pelabuhan Kotabunan atau Bitung.' },
  ],
  ...
  internal_links: [
    { label: 'Industri Konstruksi', href: '/industri/konstruksi' },
    { label: 'Batu Kapur (Limestone)', href: '/produk/batu-kapur' },
    { label: 'Lokasi Tambang Ratatotok', href: '/lokasi/ratatotok' },
  ],
};
